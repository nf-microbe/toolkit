process VTDB_CLASSIFICATIONFILTER {
    ...
    path classification_filters

    output:
    tuple val(meta), path("${prefix}_class_data.tsv")   , emit: class_data
    ...
    """
    classificationfilter.py \\
        --input ${combined_data} \\
        --filters ${classification_filters} \\
        --output ${prefix}_class_data.tsv \\
        ${args}
